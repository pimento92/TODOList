...
?>
	...
	<div class="p-2 container-lang">
		<form class="idioma" name='idiomaform' action="../Functions/CambioIdioma.php" method="post">
		<button class="langbtn" name="idioma" value="ENGLISH"><img src="../Views/images/Language/English.png" onclick='this.form.submit()' style="width:30"></button>	
		<button class="langbtn" name="idioma" value="SPANISH"><img src="../Views/images/Language/Spanish.png" onclick='this.form.submit()' style="width:30"></button>
			<button class="langbtn" name="idioma" value="GALLAECIAN"><img src="../Views/images/Language/Galician.png" onclick='this.form.submit()' style="width:30"></button>
